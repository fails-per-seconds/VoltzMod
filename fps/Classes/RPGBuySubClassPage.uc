class RPGBuySubClassPage extends GUIPage;
...
defaultproperties
{
     ...
     End Object
     Controls(0)=GUIButton'fps.RPGBuySubClassPage.QuitBackground'
     ...
     Begin Object Class=GUIButton Name=SubClassBuyButton
         ...
         bBoundToParent=True
         bScaleToParent=True
         OnClick=RPGBuySubClassPage.BuySubClass
         OnKeyEvent=SubClassBuyButton.InternalOnKeyEvent
     End Object
     Controls(1)=GUIButton'fps.RPGBuySubClassPage.SubClassBuyButton'
     ...
     Begin Object Class=GUIButton Name=CloseButton
         ...
         bBoundToParent=True
         bScaleToParent=True
         OnClick=RPGBuySubClassPage.CloseClick
         OnKeyEvent=CloseButton.InternalOnKeyEvent
     End Object
     Controls(2)=GUIButton'fps.RPGBuySubClassPage.CloseButton'
     ...
     Begin Object Class=GUIListBox Name=SubClassList
         ...
         bBoundToParent=True
         bScaleToParent=True
         OnClick=RPGBuySubClassPage.UpdateSubClassButtons
     End Object
     Controls(3)=GUIListBox'fps.RPGBuySubClassPage.SubClassList'
     ...
     Begin Object Class=GUILabel Name=SelectText
         ...
         bScaleToParent=True
     End Object
     Controls(4)=GUILabel'fps.RPGBuySubClassPage.SelectText'
