		...
		if (OldWeapon != None)
		{
			...
			(
				(
					...
					class'MutFPS'.static.IsSuperWeaponAmmo(OldWeapon.default.FireModeClass[0].default.AmmoClass)
				) ||
				(
					...
					class'MutFPS'.static.IsSuperWeaponAmmo(OldWeapon.default.FireModeClass[1].default.AmmoClass)
				)
			)
			{
