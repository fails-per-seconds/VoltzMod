...
defaultproperties
{
     ...
     Description(0)="Allows defense sentinels to supply adrenaline when they are not busy. Each level adds 1 to each healing shot.|Cost (per level): 10,10,10,10,10,..."
     StartingCost=10
     MaxLevel=10
}
