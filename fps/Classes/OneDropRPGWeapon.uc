...
static function bool CheckCorrectDamage(Weapon W, class<DamageType> DamageType)
{
	...
	if (ClassIsChildOf(W.Class,class'RocketLauncher') && ClassIsChildOf(DamageType,class'DamTypeRocketHoming'))
		return true;
	else if (ClassIsChildOf(W.Class,class'Painter') && ClassIsChildOf(DamageType,class'DamTypeIonBlast'))
		return true;
	else if (ClassIsChildOf(W.Class,class'ShockRifle') && ClassIsChildOf(DamageType,class'DamTypeShockCombo'))
		return true;
	else if (ClassIsChildOf(W.Class,class'SniperRifle') && ClassIsChildOf(DamageType,class'DamTypeSniperHeadShot'))
		return true;
	else if (ClassIsChildOf(W.Class,class'ShieldGun') && ClassIsChildOf(DamageType,class'DamTypeShieldImpact'))
		return true;
	else if (ClassIsChildOf(W.Class,class'LinkGun') && ClassIsChildOf(DamageType,class'DamTypeLinkShaft'))
		return true;
