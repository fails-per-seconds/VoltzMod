class STY_MyHome extends STY2SquareButton;
...
defaultproperties
{
     ...
     Images(0)=Texture'fps.bthome.bt_home'
     Images(1)=Texture'fps.bthome.bw_home'
     Images(2)=Texture'fps.bthome.bt_home'
     Images(3)=Texture'fps.bthome.bp_home'
