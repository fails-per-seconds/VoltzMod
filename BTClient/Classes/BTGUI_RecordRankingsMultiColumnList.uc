...
defaultproperties
{
     ...
     InitColumnPerc(1)=0.125000
     InitColumnPerc(2)=0.435000
     InitColumnPerc(3)=0.200000
     InitColumnPerc(4)=0.165000
     ...
     GetItemHeight=BTGUI_RecordRankingsMultiColumnList.InternalGetItemHeight
     bSorted=True
     SelectedStyleName="BTListSelection"
     SelectedBKColor=(B=255)
     OnDrawItem=BTGUI_RecordRankingsMultiColumnList.DrawItem
